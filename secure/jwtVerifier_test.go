...
func TestVerifyJWTSuccess(t *testing.T) {
	...
	mockC := &HTTPClientMock{
		Res: generateResMock(200, `{"id":"abc","aud":"","role":"","email":"mock@mock","confirmed_at":"2022-02-08T00:00:00Z","confirmation_sent_at":"2022-02-08T00:00:00Z","app_metadata":{"provider":"email"},"user_metadata":{"full_name":"Sir Legacy"},"created_at":"2022-02-08T00:00:00Z","updated_at":"2022-02-08T00:00:00Z"}`),
	}
